...
Tier       : Core
Scheduled  : Wed 16 Sep 2026  (week 1)

RECOGNITION HINT  (read only AFTER a real attempt)
    Single pass with a running counter reset to 0 on a zero. Track the
    max as you go.
...
class Solution:
    ...
    #  Time  : O(?)      Space : O(?)
    # -----------------------------------------------------------------
    def findMaxConsecutiveOnes_brute(self, nums: List[int]) -> int:
