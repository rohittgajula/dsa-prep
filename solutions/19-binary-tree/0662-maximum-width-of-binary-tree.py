...
RECOGNITION HINT  (read only AFTER a real attempt)
    Assign heap-style indices (2i, 2i+1) and take last minus first per
    level. Normalise to avoid overflow.
...
class Solution:
    def widthOfBinaryTree_brute(self, root: Optional[TreeNode]) -> int:
        pass
