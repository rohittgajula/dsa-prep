...
Scheduled  : Fri 08 Jan 2027  (week 17)

INPUT
    root1 : root of a binary tree
    root2 : root of a binary tree
...
RECOGNITION HINT  (read only AFTER a real attempt)
    Recurse on both simultaneously; if one side is null return the
    other.
...
class Solution:
    def mergeTrees_brute(self, root1: Optional[TreeNode], root2: Optional[TreeNode]) -> Optional[TreeNode]:
        pass
    ...
    for label, fname, brute in (("BRUTE FORCE", METHOD + "_brute", True),
        ...
        for n, (args, want) in enumerate(TESTS, 1):
            ...
            try:
                ...
                continue
            got = got if isinstance(got, list) else dump_tree(got)
