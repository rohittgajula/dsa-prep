...
RECOGNITION HINT  (read only AFTER a real attempt)
    Ambiguous in general. Use preorder[1] to determine the left
    subtree's size.
...
class Solution:
    def constructFromPrePost_brute(self, preorder: List[int], postorder: List[int]) -> Optional[TreeNode]:
        pass
