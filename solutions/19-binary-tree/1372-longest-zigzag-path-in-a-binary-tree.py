...
EXAMPLE
    root = [1, None, 1, 1, 1, None, None, 1, 1, None, ...
    ->  3

RECOGNITION HINT  (read only AFTER a real attempt)
    Return (leftLen, rightLen) upward; a zigzag continues by alternating
    direction.
...
class Solution:
    def longestZigZag_brute(self, root: Optional[TreeNode]) -> int:
        pass
