...
Pattern    : Binary Tree
Tier       : Core
Scheduled  : Wed 13 Jan 2027  (week 18)
...
EXAMPLE
    root = [10, 5, -3, 3, 2, None, 11, 3, -2, None, 1], targetSum =
    8
    ->  3

RECOGNITION HINT  (read only AFTER a real attempt)
    Path can start anywhere -> prefix sum plus hashmap along the root-
    to-node path. Remove on backtrack.
