...
EXAMPLE
    root = [10, 5, 15, 3, 7, None, 18], low = 7, high = 15
    ->  32

RECOGNITION HINT  (read only AFTER a real attempt)
    Prune: if node.val < low skip the entire left subtree, and
    symmetrically for high.
...
class Solution:
    def rangeSumBST_brute(self, root: Optional[TreeNode], low: int, high: int) -> int:
        pass
