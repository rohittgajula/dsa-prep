...
Pattern    : BST
Tier       : Core
Scheduled  : Sun 24 Jan 2027  (week 19)

RECOGNITION HINT  (read only AFTER a real attempt)
    Descend while both values sit on the same side; the first node that
    splits them is the LCA.
...
INPLACE_ARG = None
NODE_BY_VALUE = [1, 2]   # judge sends a value here, the method wants that node
RETURN_AS   = 'node_val'   # compare the returned node by its value
