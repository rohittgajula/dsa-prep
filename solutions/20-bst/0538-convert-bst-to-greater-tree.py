...
Scheduled  : Thu 21 Jan 2027  (week 19)
...
EXAMPLE
    root = [4, 1, 6, 0, 2, 5, 7, None, None, None, 3, ...
    ->  [30, 36, 21, 36, 35, 26, 15, None, None, No...

RECOGNITION HINT  (read only AFTER a real attempt)
    REVERSE inorder (right, root, left) with a running sum.
...
class Solution:
    def convertBST_brute(self, root: Optional[TreeNode]) -> Optional[TreeNode]:
        pass
