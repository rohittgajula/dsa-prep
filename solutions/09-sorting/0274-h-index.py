...
Scheduled  : Mon 09 Nov 2026  (week 9)

RECOGNITION HINT  (read only AFTER a real attempt)
    Sort descending and find the largest i where citations[i] >= i+1.
    Counting sort gives O(n).
...
class Solution:
    ...
    #  Time  : O(?)      Space : O(?)
    # -----------------------------------------------------------------
    def hIndex_brute(self, citations: List[int]) -> int:
