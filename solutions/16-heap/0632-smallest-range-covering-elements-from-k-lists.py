...
INPUT
    nums : grid of integers

RETURN
    list of integers

EXAMPLE
    nums = [[4, 10, 15, 24, 26], [0, 9, 12, 20], [5, 1...
    ->  [20, 24]

RECOGNITION HINT  (read only AFTER a real attempt)
    K-way merge tracking the current max; the heap top is the min, so
    the range is max - top.
...
class Solution:
    def smallestRange_brute(self, nums: List[List[int]]) -> List[int]:
        pass
