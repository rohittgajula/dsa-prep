...
OPERATIONS
    LRUCache(capacity)   with capacity = integer
    get(key)  ->  integer
    put(key, value)  ->  nothing

RECOGNITION HINT  (read only AFTER a real attempt)
    Hash map plus DOUBLY linked list. Dummy head and tail sentinels
    remove every edge case.
...
CLASS_BRUTE   = LRUCacheBrute
CLASS_OPTIMAL = LRUCache
