...
Scheduled  : Tue 16 Mar 2027  (week 27)
...
RECOGNITION HINT  (read only AFTER a real attempt)
    Greedy post-order with three node states: needs cover, has camera,
    is covered.
...
class Solution:
    def minCameraCover_brute(self, root: Optional[TreeNode]) -> int:
        pass
