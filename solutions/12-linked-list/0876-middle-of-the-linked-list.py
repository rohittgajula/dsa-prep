...
RECOGNITION HINT  (read only AFTER a real attempt)
    Fast and slow pointers. Your loop condition decides which middle you
    get for even lengths.
...
class Solution:
    def middleNode_brute(self, head: Optional[ListNode]) -> Optional[ListNode]:
        pass
