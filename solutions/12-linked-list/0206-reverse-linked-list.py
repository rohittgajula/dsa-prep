...
RECOGNITION HINT  (read only AFTER a real attempt)
    Three pointers: prev, cur, next. Save next BEFORE you overwrite
    cur.next. Do it iteratively and recursively.
...
class Solution:
    def reverseList_brute(self, head: Optional[ListNode]) -> Optional[ListNode]:
        pass
